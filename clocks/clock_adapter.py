...
class AnalogClockAdapter(BaseDigitalClock):
    ...
    def set_date_time(self, date: datetime) -> None:
        ...
        hour_angle, minute_angle, second_angle = ClockTimeHelper.calculate_time_angles(date)
    ...
    def get_date_time(self) -> datetime:
        ...
        hour, minute, second = ClockTimeHelper.calculate_time_from_angles(hour_angle, minute_angle, second_angle)
        hour = ClockTimeHelper.adjust_for_day_night(hour, self._analog_clock.day_night_division)
